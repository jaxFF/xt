...
%CompileCommand% %CommonCompilerFlags% -I..\src -I..\imgui -I..\imgui\examples ..\demo\win32_main.cpp -MT -Fowin32_main.obj -Fmwin32_main.map /link %CommonLinkerFlags% libfstd.lib
